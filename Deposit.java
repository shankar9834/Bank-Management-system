...
interface Deposit extends Imp_Functions
{
    default public void deposit_amount(String Account_Number)
    {
        try
        {
            ...
            long deposit_amount = input.nextLong();
            ...
            if (compare_string(pin, pin2))
            {
                ...
                System.out.println("|------------------------------------------------------------------------------------|");
                System.out.println("|     Amount of Rs." + deposit_amount + "Deposited Successfully in your Account" );
